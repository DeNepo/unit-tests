...
// for now we only care about .expect, so let's assign it to a separate variable
...
try {
  expect(4).to.equal(4); // the same as ===
  console.log('PASS!');
} catch (error) {
...
//     to learn all the things chai can check: https://www.chaijs.com/api/bdd/
